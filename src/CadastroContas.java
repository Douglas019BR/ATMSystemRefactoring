...
public class CadastroContas {
	...
	//Operacoes
	  ...
	  public CadastroContas () {  // método construtor 
	    ...
	    c[1]=new ContaCor("Juliana",500,1,1, TipoCobranca.PREMIUM);
	    System.out.println("Conta de Juliana criada com id 1 senha 1 e 500,00");
	    
	    c[2]=new ContaCor("Maria",500,2,2,TipoCobranca.COBRANCA_POR_OPERACAO);
	    System.out.println("Conta de Maria criada com id 2 senha 2 e 500,00");
	    
	    c[3]=new ContaCor("Nestor",500,3,3,TipoCobranca.BASICO);
